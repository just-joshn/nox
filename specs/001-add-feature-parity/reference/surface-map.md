...
| CLI-519 misspelled subcommand | `nox <misspelled-command>` suggests the closest nox subcommand, for example `nox udpate` → `nox update` | Nox early decision implemented; executable naming, diagnostic, and startup side effects differ as DISC-002 |
