...
class LoopbackProbeTests(unittest.TestCase):
    ...
    def test_search_option_call_contains_only_selected_synthetic_fields(self):
        ...
        multiline = message_response("test-model", "tool", "fixture.txt", "Grep", "alpha\nbeta", multiline=True)
        self.assertIn('\\"multiline\\": true', multiline.decode())
    ...
    def test_search_result_summary_recognizes_only_exact_synthetic_formats(self):
        ...
        self.assertEqual(summarize_search_result({"content": "No entries at this offset\n\n[Showing results with pagination = offset: 2]"}, "Grep")["result_format"], "offset_end")
        ...
        self.assertEqual(summarize_search_result({"content": "fixture.txt\n.hidden.txt"}, "Glob")["result_format"], "glob_hidden")
        self.assertEqual(summarize_search_result({"content": ".hidden.txt\nfixture.txt"}, "Glob")["result_format"], "glob_mtime")
        self.assertEqual(summarize_search_result({"content": "fixture.txt\nignored.txt"}, "Glob")["result_format"], "glob_ignored")
        self.assertEqual(summarize_search_result({"content": "fixture.txt\n.git/inner.txt"}, "Glob")["result_format"], "glob_git_metadata")
        self.assertEqual(summarize_search_result({"content": "Found 2 files\n.hidden.txt\nfixture.txt"}, "Grep")["result_format"], "grep_hidden")
        self.assertEqual(summarize_search_result({"content": "Found 2 files\nfixture.txt\n.hidden.txt"}, "Grep")["result_format"], "grep_mtime")
        ...
        self.assertEqual(summarize_search_result({"content": "No entries at this offset. [Showing results with pagination = offset: 2]"}, "Grep")["result_format"], "grep_files_offset_end")
