...
| US1-READ-001 | Synthetic loopback normal and missing-path result-shape traces captured; exact error text, permission boundary, content limits, and real-service behavior unobserved | Disposable permission fixture, then restored usage allowance for matched real-service observation |
