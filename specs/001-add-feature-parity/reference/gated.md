...
| TOOL-002 | Sandboxed normal, no-match, and invalid-bracket Glob decisions observed; exact result/error formatting, other invalid patterns, permission behavior, and real-service use remain unobserved | Same disposable network sandbox and localhost Messages endpoint; compare exact sanitized result/error formatting, other invalid patterns, and permission behavior |
| TOOL-003 | Sandboxed normal, no-match, and invalid-bracket Grep decisions observed; exact result/error formatting, other invalid queries, permission behavior, and real-service use remain unobserved | Same disposable network sandbox and localhost Messages endpoint; compare exact sanitized result/error formatting, other invalid queries, and permission behavior |
...
| US1-SEARCH-PATH-001 | Synthetic localhost Glob normal/no-match/invalid result shapes observed; exact invalid diagnostic, interactive permission, real-service behavior, and broader option combinations unobserved | Authorized interactive disposable fixture and restored usage allowance for real-service comparisons; keep probes offline until user changes that instruction |
| US1-SEARCH-CONTENT-001 | Synthetic localhost Grep normal/no-match/invalid and selected option result shapes observed; exact invalid diagnostic, interactive permission, real-service behavior, and broader option combinations unobserved | Authorized interactive disposable fixture and restored usage allowance for real-service comparisons; keep probes offline until user changes that instruction |
