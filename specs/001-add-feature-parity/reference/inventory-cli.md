...
| CLI-563 | `-d` (short alias for `--debug`) | [local help](observations/cli-help-2026-09-14.txt) | [Offline parser comparison](observations/cli-debug-short-alias-2026-09-14.txt): paired version and unknown-option exits match `--debug`; filtering and logs pending; nox has no equivalent parser flag yet |
| CLI-564 | `-n` (short alias for `--name`) | [local help](observations/cli-help-2026-09-14.txt) | [Offline missing-value comparison](observations/cli-name-short-alias-missing-2026-09-14.txt): both spellings exit 1 with identical diagnostic and no side effects; nox diagnostic differs; successful naming pending |
...
| CLI-566 | `-w` (short alias for `--worktree`) | [local help](observations/cli-help-2026-09-14.txt) | [Offline parser comparison](observations/cli-worktree-short-alias-2026-09-14.txt): paired version and unknown-option exits match `--worktree`; creation and optional name pending; nox has no equivalent parser flag yet |
