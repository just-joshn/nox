...
| [Mobile](https://code.claude.com/docs/en/mobile) | Cloud task, local Remote Control, attachments, mode selection, notifications → SUR-PLAT-006–007 and SUR-PLAT-013–023 | Remote session pairing overlaps SUR-RC; Dispatch overlaps Desktop; all mobile behaviors require eligible device/account observation |
