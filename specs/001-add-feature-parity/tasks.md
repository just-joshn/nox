...
**Blocking checkpoint**: Do not begin or mark additional source tasks complete until T002–T007 and T062 pass. Record the final leaf count and every gated leaf in `specs/001-add-feature-parity/reference/reconciliation.md`. Every discovered capability must have a stable leaf ID and explicit availability state; the inventory is a coverage target, not a verified implementation.
...
- [ ] T013 Validate that every leaf in `specs/001-add-feature-parity/reference/reconciliation.md` has separate evidence, failing-test, implementation, and verification tasks in `specs/001-add-feature-parity/tasks.md`; list missing task IDs there and keep T013 open until the missing-task count is zero.

**Inventory dependency**: T002–T005 and T062 must pass before T006; T006 must pass before T007; T007 and the applicable T009–T011 evidence must pass before T013. T013 must report zero missing leaf-task mappings before any additional source implementation task begins.
...
- [X] T278 [US1] Implement explicit Read tool adapter in `packages/coding-agent/src/core/tools/claude-read.ts` matching the observed schema and formatted line number text; verify with focused tests, settings tests, harness tests and `npm run check`, then commit locally.
- [X] T279 [US1] Implement explicit Edit tool adapter in `packages/coding-agent/src/core/tools/claude-edit.ts` matching the observed schema, replacement semantics, error messages and success text; verify with focused tests, settings tests, harness tests and `npm run check`, then commit locally.
- [X] T280 [US1] Implement explicit Bash tool adapter in `packages/coding-agent/src/core/tools/claude-bash.ts` matching the observed schema, nonzero exit formatting, and timeout behavior; verify with focused tests, settings tests, harness tests and `npm run check`, then commit locally.
...
- [ ] T019 [US1] Resolve the explicitly mapped US1 leaf discrepancies in `specs/001-add-feature-parity/reference/discrepancies.md`, run `packages/coding-agent/test/suite/parity-core-workflow.test.ts`, and document Pi visual comparisons in `specs/001-add-feature-parity/reference/pi-visuals.md`.
...
- [ ] T063 [US1] Checkpoint — Verify every agent-execution leaf has an observed contract, separate failing-test task, separate implementation task, passing verification task, and Pi-state result; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T064 [US1] Checkpoint — Verify every built-in-tool leaf has an observed contract, separate failing-test task, separate implementation task, passing verification task, and applicable permission/error result; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T068 [US1] Checkpoint — Verify every terminal-interaction leaf has an observed contract, separate failing-test task, separate implementation task, passing verification task, and required Pi visual matrix result; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T081 [US1] Checkpoint — Verify every computer-use and browser-use leaf has an observed contract, separate failing-test task, separate implementation task, passing verification task, and permission/platform-gate result; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T086 [US1] Checkpoint — Verify every context-window, caching, image, large-input, and context-reduction leaf has an observed contract, separate failing-test task, separate implementation task, and passing verification task; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T023 [US2] Checkpoint — Verify every session identity, naming, continuation, resume, fork, compaction, and persistence leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T024 [US2] Checkpoint — Verify every permission-mode, rule-precedence, persistence, prompt, denial, unattended, credential-reuse, and redaction leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T025 [US2] Checkpoint — Verify every model, effort, fallback, context, and budget leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T026 [US2] Checkpoint — Verify every session and permission Pi-control leaf has separate observed-evidence, failing-test, implementation, passing-verification, and visual-matrix tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T065 [US2] Checkpoint — Verify every model/provider-control leaf has an observed contract, separate failing-test task, separate implementation task, and passing normal, unavailable, rate-limit, and restart verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T066 [US2] Checkpoint — Verify every permission/security leaf has an observed contract, separate failing-test task, separate implementation task, and passing allow, deny, policy, restart, and disclosure verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T067 [US2] Checkpoint — Verify every session/context leaf has an observed contract, separate failing-test task, separate implementation task, and passing persistence, crash, repository-change, and context-limit verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T082 [US2] Checkpoint — Verify every goal, agent-view, cross-session-message, and dynamic-workflow leaf has an observed contract, separate failing-test task, separate implementation task, and passing coordination/recovery verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T087 [US2] Checkpoint — Verify every scheduled-prompt, reminder, repeated-prompt, and goal-continuation leaf has an observed contract, separate failing-test task, separate implementation task, and passing time-controlled verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T031 [US3] Checkpoint — Verify every settings validation, scope-precedence, and nox-native location leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T032 [US3] Checkpoint — Verify every instruction, rule, and memory discovery/precedence leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T033 [US3] Checkpoint — Verify every skill and custom-command discovery, invocation, argument, and failure leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T034 [US3] Checkpoint — Verify every agent isolation, tool-selection, lifecycle, and result leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T035 [US3] Checkpoint — Verify every hook event, ordering, input/output, blocking, and failure leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T036 [US3] Checkpoint — Verify every external-connection discovery, authorization, resource, prompt, tool, exposure, and redaction leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T037 [US3] Checkpoint — Verify every plugin discovery, enablement, namespace, installation, and update leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T069 [US3] Checkpoint — Verify every settings, instruction, rules, and memory leaf has an observed contract, separate failing-test task, separate implementation task, and passing conflict, invalid-value, restart, and isolation verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T070 [US3] Checkpoint — Verify every skill and command leaf has an observed contract, separate failing-test task, separate implementation task, and passing duplicate, disabled, error, and precedence verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T071 [US3] Checkpoint — Verify every hook leaf has an observed contract, separate failing-test task, separate implementation task, and passing ordering, cancellation, invalid-output, restart, and disclosure verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T072 [US3] Checkpoint — Verify every agent, subagent, team, task, message, and delegation leaf has an observed contract, separate failing-test task, separate implementation task, and passing failure/cancellation/concurrency verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T073 [US3] Checkpoint — Verify every plugin, marketplace, and external-connection leaf has an observed contract, separate failing-test task, separate implementation task, and passing scope, offline, permission, redaction, and lifecycle verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T084 [US3] Checkpoint — Verify every plugin-evaluation leaf has an observed contract, separate failing-test task, separate implementation task, and passing repeatability and failure verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T088 [US3] Checkpoint — Verify every extension-diagnostic and debugging leaf has an observed contract, separate failing-test task, separate implementation task, and passing precedence, disabled, invalid-setting, and connection-failure verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T041 [US4] Checkpoint — Verify every print format, structured-output, stream, partial-event, RPC, and exit leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T042 [US4] Checkpoint — Verify every worktree isolation, naming, lifecycle, and cleanup leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T043 [US4] Checkpoint — Verify every remote and desktop/web/mobile/editor/browser/chat/CI leaf has a nox control, observed interaction/data-exposure contract, separate failing-test task, implementation task, and passing-verification task mapped in `specs/001-add-feature-parity/reference/reconciliation.md`; retain inaccessible leaves as `gated-unverified`.
- [ ] T044 [US4] Checkpoint — Verify every authentication, diagnostic, import, project-state, update, external-management, and hosted-review command leaf has separate observed-evidence, failing-test, implementation, and passing-verification tasks mapped in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T074 [US4] Checkpoint — Verify every noninteractive and programmatic leaf has an observed contract, separate failing-test task, separate implementation task, and passing malformed-input, backpressure, interruption, and failure verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T075 [US4] Checkpoint — Verify every CLI and administration leaf has an observed contract, separate failing-test task, separate implementation task, and passing help, default, conflict, exit, and state-change verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T076 [US4] Checkpoint — Verify every worktree, source-control, automation, scheduling, hosted-review, and notification leaf has an observed contract, separate failing-test task, separate implementation task, and passing lifecycle verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T077 [US4] Checkpoint — Verify every remote and platform-surface leaf has an observed contract, separate failing-test task, separate implementation task, and passing entry, interaction, disclosure, failure, disconnect, and resume verification; record gated leaves and missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- [ ] T083 [US4] Checkpoint — Verify every hosted-review and security-workflow leaf has an observed contract, separate failing-test task, separate implementation task, and passing permission, disclosure, provider, and gated-case verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T085 [US4] Checkpoint — Verify every artifact, sharing, deep-link, and cross-surface-access leaf has an observed contract, separate failing-test task, separate implementation task, and passing ownership, denial, expiration, and disconnect verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T089 [US4] Checkpoint — Verify every desktop scheduling, dispatch, preview, visual-diff, and editor/simulator leaf has an observed contract, separate failing-test task, separate implementation task, and passing handoff, permission, failure, and service-gate verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
- [ ] T090 [US4] Checkpoint — Verify every deep-link, channel-event, and external-trigger leaf has an observed contract, separate failing-test task, separate implementation task, and passing ordering, replay, disconnect, and authorization verification; record missing mappings in `specs/001-add-feature-parity/reference/reconciliation.md`.
...
- **US1**: T014 and T015 may run concurrently; T016–T019 remain blocked until T013 reports zero missing mappings for their leaves.
...
- **US3**: T029 and T030 may run concurrently after their leaf evidence exists; T031–T037 are checkpoints until T013 creates separate implementation tasks.
- **US4**: T039 and T040 may run concurrently after their leaf evidence exists; T041–T044 are checkpoints until T013 creates separate implementation tasks.
