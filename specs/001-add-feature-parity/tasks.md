...
- [ ] T218 [US1] Write a failing nox test for observed Grep file-list offset-past-end text, implement that explicit boundary without changing other modes, verify focused/neighboring tests and `npm run check`, then commit locally.
