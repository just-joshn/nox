...
- [ ] T114 [US4] Add a narrowly scoped prompt-file missing-value preflight in `packages/coding-agent/src/cli.ts` before startup initialization, preserving normal prompt text and valid file-flag handling.
