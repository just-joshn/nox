...
- [ ] T265 [US1] Compare nox's empty-pattern single-file Grep content with T264; write a failing test if needed, implement the observed file-target output shape, verify focused tests and `npm run check`, then commit locally.
