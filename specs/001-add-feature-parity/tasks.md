...
- [ ] T185 [US1] Write a failing nox test for observed multiline count output, enable ripgrep multiline mode in the explicit count helper, verify focused/neighboring tests and `npm run check`, then commit locally.
