...
- [ ] T232 [US1] Compare nox's explicit Grep content no-match offset output with T231; write a failing test if needed, implement only the observed boundary, verify focused tests and `npm run check`, then commit locally.
