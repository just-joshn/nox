...
- [ ] T170 [US1] Write a failing nox test for observed Grep offset-past-end output, implement that explicit content-mode boundary, verify focused/neighboring tests and `npm run check`, then commit locally.
