...
- [ ] T258 [US1] Compare nox's negative Grep `-C` behavior with T257; write a failing test and validate explicit context input before searching, verify focused tests and `npm run check`, then commit locally.
