...
- [ ] T260 [US1] Compare nox's negative Grep `context` alias behavior with T259; write a failing test and validate the alias before searching, verify focused tests and `npm run check`, then commit locally.
